...
/**
 * 实现阻塞队列：
 * 1.线程安全问题：队列中的4个属性，put、take不具有原子性，4个属性，不具有可见性
 * 2.put操作，如果存满了，需要阻塞等待；take操作如果是空，需要阻塞等待
 * @param <T>
 */
public class MyBlockingQueue <T> {
    ...
    public synchronized void put(T e) throws InterruptedException {
        //当阻塞等待到被唤醒并再次竞争成功对象锁，恢复后往下执行，条件可能被其他线程修改
    ...
    public static void main(String[] args) {
        ...
        //多线程的调试方式：1.写打印语句 2.jconsole 3.debug在有些场景下不一定适用
        for(int i = 0; i < 3; i++) {
