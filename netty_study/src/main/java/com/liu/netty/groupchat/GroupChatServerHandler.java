...
//    public static Map<User, Channel> channels2 = new HashMap<>();
    ...
    //GlobalEventExecutor.INSTANCE 是全局的事件执行器，是单例的
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        //该方法会将channelGroup中所有的channel遍历，并发送给消息，因此不需要遍历
        channelGroup.writeAndFlush("[客户端]" + channel.remoteAddress() + "加入聊天" +
                sdf.format(System.currentTimeMillis()) +"\n");
        channelGroup.add(channel);

//        channels.put("id100", channel);
//        channels2.put(new User(), channel);
    }

    //断开连接会触发，将xxx客户离开信息推送给当前在线的客户
    @Override
